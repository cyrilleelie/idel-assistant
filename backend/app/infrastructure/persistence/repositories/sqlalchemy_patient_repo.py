...
class SQLAlchemyPatientRepo(PatientRepository):
    ...
    def _model_to_entity(self, model: PatientModel) -> Patient:
        ...
        return Patient(
            ...
            has_active_bsi=model.has_active_bsi,
            bsi_level=model.bsi_level,
            bsi_start_date=model.bsi_start_date,
            bsi_end_date=model.bsi_end_date,
            status=model.status,
    ...
    def _entity_to_model_data(self, patient: Patient) -> dict:
        ...
        data = {
            ...
            "bsi_start_date": patient.bsi_start_date,
            "bsi_end_date": patient.bsi_end_date,
