  ...
  return (
    <div className="space-y-4">
      ...
      <TransmissionFiltersBar
        ...
        authors={nurses.map(n => ({ id: n.id, name: `${n.first_name || ''} ${n.last_name || ''}`.trim() }))}
      />
      ...
      {!loading && transmissions.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-slate-500 font-medium">
            {(filters.search || filters.prescription_id || filters.status || filters.author_user_id || filters.date_from)
              ? 'Aucune transmission ne correspond aux filtres.'
