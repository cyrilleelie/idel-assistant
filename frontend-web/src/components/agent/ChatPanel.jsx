  ...
  return (
    <>
      ...
      >
        ...
        {/* Mode selector */}
        <div className="flex border-b border-slate-100 bg-slate-50 overflow-x-auto shrink-0">
          {MODES.map((mode) => (
            <button
              key={mode.id}
              ...
              <div className="space-y-2 w-full">
                {currentMode.suggestions.map((suggestion) => (
                  <button
                    ...
                    className="w-full text-left text-xs bg-white border border-slate-200 rounded-lg px-3 py-2
                      text-slate-600 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700
